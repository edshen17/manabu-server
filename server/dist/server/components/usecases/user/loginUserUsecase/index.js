...
const oAUthRedirectUrl = redirectUrlBuilder_1.makeRedirectUrlBuilder
    .host('server')
    .endpoint('/users/auth/google/login')
    .build();
const oauth2Client = new googleapis_1.google.auth.OAuth2(constants_1.G_CLIENTID, constants_1.GOOGLE_CLIENT_SECRET, oAUthRedirectUrl);
