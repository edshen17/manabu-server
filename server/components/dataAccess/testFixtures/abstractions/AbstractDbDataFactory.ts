...
abstract class AbstractDbDataFactory<DbDoc, EntityResponse> implements IFakeDbDataFactory<DbDoc> {
  ...
  protected abstract _createFakeEntity(entityData: any): Promise<EntityResponse>;
  ...
  public init = async (props: {
    makeEntity: Promise<IEntity<EntityResponse>>;
    makeDbService: Promise<IDbOperations<DbDoc>>;
  }): Promise<this> => {
