...
describe('userDb service', () => {
  describe('findById', () => {
    ...
    it('given an existing user id (viewing teacher as admin), should return only relevant data', async () => {
    ...
    // it('given an existing user id (viewing admin & teacher as self), should return only relevant data', async () => {
    //   const accessOptionsCopy: AccessOptions = JSON.parse(JSON.stringify(accessOptions));
    //   accessOptionsCopy.currentAPIUserRole = 'admin';
    //   accessOptionsCopy.isSelf = true;
